...
def converter_table_glove():
    ...
    path = str(os.path.dirname(os.path.abspath(__file__))) + "/data/converter_table_glove"
...
def converter_table_word2vec():
    ...
    path = str(os.path.dirname(os.path.abspath(__file__))) + "/data/converter_table_word2vec"
...
def evaluate_quality(sequence, word, related_count, perplexity, guide, temp=1.0):
...
# A score function for the quality of the sentence
def evaluate_quality_linear(sequence, word_count, perplexity, temp=1.0, perp=False):
    # we aim for one ocurance of the word,  and low perplexity
    w_1 = 1
    w_3 = 0.01
