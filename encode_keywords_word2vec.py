...
if encode_50keywords == True:
    file1 = open(str(os.path.dirname(os.path.abspath(__file__))) + file_name, "r+")
    ...
    for line in lines:
        ...
        save_path = str(os.path.dirname(os.path.abspath(__file__))) + folder + "/set_" + str(i) + ".npy"

        np.save(save_path, word2vec_words)
        i = i + 1

    save_path_dict = str(os.path.dirname(os.path.abspath(__file__))) + folder + "/dict_word2vec.pkl"
